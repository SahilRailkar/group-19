...
class DiamondCollector(gym.Env):
    ...
    def step(self, action):
        ...
        # if observations:
        #     print("IN STEP ", observations["ZPos"])
        #     self.curZPos = observations['ZPos']

        # attackCom = "attack "
        # attack = False
        # if self.attack and self.allow_break_action:
        #     attackCom += "1"
        #     attack = True
        # else:
        #     attackCom += "0"
        ...
        # else:
        #     self.attack = False
        # moveCom = "move {}".format(action[0] if not self.attack else 0)
        # turnCom = "turn {}".format(action[1] if not self.attack else 0)

        # if (self.prev_attack == "attack 1" and attackCom == "attack 0") or (self.prev_attack == "attack 0" and attackCom == "attack 1"):
        #     self.agent_host.sendCommand(attackCom)
        # if attack:
        #     time.sleep(.8)
        # self.agent_host.sendCommand(turnCom)
        # self.agent_host.sendCommand(moveCom)
        # if not attack:
        #     time.sleep(.3)

        # self.prev_attack = attackCom
